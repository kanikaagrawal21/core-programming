...
public class AmarAkbarAnthonyAgeAndHeight {
    public static void main(String[] args) {
        ...
        System.out.println(AgeAndHeight(heightAmar, heightAkbar, heightAnthony, ageAmar,  ageAkbar,  ageAnthony));
    }
    public static String AgeAndHeight(int heightAmar,int heightAkbar,int heightAnthony,int ageAmar, int ageAkbar, int ageAnthony){
